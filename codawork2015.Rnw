...
Merge the components $I_a$ and $I_b$ that maximize the probability of assigning to component $I_b$ obsrvations generated by $I_a$ (misclassification).

for which the probability of assigning one observation generated by component $I_a$ to $I_b$ is maximum.
\end{alertblock}
...
\item The merging approach is similar to principal balances methods. Does it make sense to consider principal balances here?
\end{itemize}
\end{frame}
